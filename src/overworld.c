...
void SwitchMonNatureHardy(void){
	SwitchMonNature(NATURE_HARDY); }
	
void SwitchMonNatureDocile(void){
	SwitchMonNature(NATURE_DOCILE); }
	
void SwitchMonNatureLax(void){
	SwitchMonNature(NATURE_LAX); }
	
void SwitchMonNatureSerious(void){
	SwitchMonNature(NATURE_SERIOUS); }
...
void SwitchMonNatureQuirky(void){
	SwitchMonNature(NATURE_QUIRKY); }
